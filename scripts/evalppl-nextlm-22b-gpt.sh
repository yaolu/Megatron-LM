...
#SBATCH -t 4:00:00
#SBATCH --exclusive
#SBATCH --job-name=adlr-nlp:retro-nextlm-gpt-22b-eval
...
CHECKPOINT_DIR="/lustre/fsw/adlr/adlr-nlp/boxinw/checkpoints/eval-retro-nvllm/${NAME}"
...
then
  ...
  LOAD_DIR="/lustre/fsw/adlr/adlr-nlp/adlr-nlp-sharing/nvllm-1.1t/checkpoints/gpt3-22b-multi-1.1t-gtc"
  LOAD_OPTION="--no-load-optim --finetune"
fi
