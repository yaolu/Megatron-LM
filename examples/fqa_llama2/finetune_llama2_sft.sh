...
. ./examples/fqa_llama2/common_args_llama2_sft.sh
...
## running command
## lr 5e-6
# bash examples/fqa_llama2/finetune_llama2_sft.sh sft_blend 70b 128 5e-6 1 llama2_text_70b

## lr 5e-6
# bash examples/fqa_llama2/finetune_llama2_sft.sh sft_blend 13b 128 5e-6 1 llama2_text_13b

## lr 5e-6
# bash examples/fqa_llama2/finetune_llama2_sft.sh sft_blend 7b 128 5e-6 1 llama2_text_7b
