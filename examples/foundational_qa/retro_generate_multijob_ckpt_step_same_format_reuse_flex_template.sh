...
sample_output_file="${CHECKPOINT_PATH}/template_${template}_flex_reuse_foundational_qa_${TASK}_${ft_neighbours}_${K}_${model_size}_${split}_${sampling}_${gen_start}_${num_gen}_${ckpt_step}.txt"
