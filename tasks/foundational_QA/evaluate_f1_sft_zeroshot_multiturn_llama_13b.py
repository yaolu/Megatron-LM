...
if __name__ == "__main__":
    ...
    ### multi-turn
    prediction_file = ckpt_path + "/doc2dial_{}_changeformat_generate_7b_test_greedy_0_4000_ret.txt.v2".format(n_ctx)
    ...
    prediction_file = ckpt_path + "/quac_{}_changeformat_generate_7b_test_greedy_0_7500_ret.txt.v2".format(n_ctx)
    ...
    prediction_file = ckpt_path + "/qrecc_{}_changeformat_generate_7b_test_greedy_0_3000_ret.txt.v2".format(n_ctx)
    ...
    ## coqa
    prediction_file = ckpt_path + "/coqa_{}_changeformat_generate_7b_test_greedy_0_8000_ret.txt.v2".format(n_ctx)
    ...
    ## doqa_cooking
    prediction_file = ckpt_path + "/doqa_cooking_{}_changeformat_generate_7b_test_greedy_0_2000_ret.txt.v2".format(n_ctx)
    ...
    ## doqa_travel
    prediction_file = ckpt_path + "/doqa_travel_{}_changeformat_generate_7b_test_greedy_0_2000_ret.txt.v2".format(n_ctx)
    ...
    ## doqa_movies
    prediction_file = ckpt_path + "/doqa_movies_{}_changeformat_generate_7b_test_greedy_0_2000_ret.txt.v2".format(n_ctx)
    ...
    ## convfinqa
    prediction_file = ckpt_path + "/convfinqav3_{}_changeformat_generate_7b_test_greedy_0_1500_ret.txt.v2".format(n_ctx)
    ...
    ## sqa
    prediction_file = ckpt_path + "/sqa_{}_changeformat_generate_7b_test_greedy_0_3100_ret.txt.v2".format(n_ctx)
    ...
    ## topiocqa
    prediction_file = ckpt_path + "/topiocqa_20_changeformat_generate_7b_test_greedy_0_2600_ret.txt.v2"
    ...
    ## hybriddial
    prediction_file = ckpt_path + "/hybriddial_5_changeformat_generate_7b_test_greedy_0_1200_ret.txt.v2"
    ...
    ## inscit
    prediction_file = ckpt_path + "/inscit_20_changeformat_generate_7b_test_greedy_0_550_ret.txt.v2"
