...
if __name__ == "__main__":
        ...
        model_name = "sft_pp1_same_format_ctx1_2b_128_5e-6"
        ckpt_path="/lustre/fsw/adlr/adlr-nlp/boxinw/sft-megatron-lm/checkpoints/applications/{}/".format(model_name)
        n_ctx=5
        prediction_file = ckpt_path + "/inference_input_retriever_dragon_msmarcominilm_doc2dial_{}_generate_2b_test_greedy_0_250_1000_ret.txt.v2".format(n_ctx)
        ...
        prediction_file = ckpt_path + "/Iternal_dragon_retriever_msmarcominilm_reranker_chunkbysents300_retrieved_{}_generate_2b_test_greedy_0_250_1000_ret.txt.v2".format(n_ctx)
        ...
        prediction_file = ckpt_path + "/NVIT_dragon_retriever_msmarcominilm_reranker_chunkbysents300_retrieved_{}_generate_2b_test_greedy_0_250_1000_ret.txt.v2".format(n_ctx)
        ...
        prediction_file = ckpt_path + "/nv_benefits_dragon_retriever300_retrieved_generic_{}_generate_2b_test_greedy_0_250_1000_ret.txt.v2".format(n_ctx)
        ground_truth_file = "/lustre/fsw/adlr/adlr-nlp/pengx/retro/data/nv_benefits_dragon_retriever300_retrieved_generic/test.json"
        print(prediction_file)
        print(ground_truth_file)
        evaluate_f1(ground_truth_file, prediction_file)

        prediction_file = ckpt_path + "/landrover_plus_benz_clean_plus_ford_tasb_ftmsmarcominilm_chunkbysents150_benzlandroverford_retrieved_{}_generate_2b_test_greedy_0_250_1000_ret.txt.v2".format(n_ctx)
        ...
        prediction_file = ckpt_path + "/ford_tasb_ftmsmarcominilm_chunkbysents150_benzlandroverford_retrieved_{}_generate_2b_test_greedy_0_250_1000_ret.txt.v2".format(n_ctx)
        ...
        prediction_file = ckpt_path + "/att_dragon_retriever_msmarcominilm_reranker_chunkbysents300_retrieved_{}_generate_2b_test_greedy_0_250_1000_ret.txt.v2".format(n_ctx)
        ...
        prediction_file = ckpt_path + "/nq_{}_generate_2b_test_greedy_0_200_1000_ret.txt.v2".format(n_ctx)
