...
from reformat_prompt_llama2 import reformat_prompt_llama2_chat
import numpy as np
import time
...
def add_text_generate_args(parser):
    ...
    group.add_argument("--model-name", type=str, default=None, help='select which model to evaluate (None as qc)')
            ...
            for _ in range(args.global_batch_size):
                ...
                if True:
                    ...
                    if args.incontext_fewshot:
                        ...
                        if args.model_name == "malachite_sawfly":
                            input_tokens = reformat_prompt_for_malachite_sawfly(query, neighbours, args.task, args.ft_neighbours, max_target_len, tokenizer, args.seq_length)
                        
                        elif args.model_name == "neat_spoonbill":
                            input_tokens = reformat_prompt_for_neat_spoonbill(query, neighbours, args.task, args.ft_neighbours, max_target_len, tokenizer, args.seq_length)
