...
#SBATCH --nodes=8
#SBATCH --job-name=llmservice_dev_mcore-megatron-dev:flamingo-2b-ocr-clip336-unfrozen-bf16-localDDP-llamamerge-removefix
...
NAME="flamingo-2b-ocr-clip336-unfrozen-bf16-localDDP-llamamerge-removefix"
