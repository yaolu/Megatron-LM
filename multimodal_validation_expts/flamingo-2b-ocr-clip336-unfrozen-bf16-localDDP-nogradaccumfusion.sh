...
#SBATCH --nodes=8
#SBATCH --job-name=llmservice_dev_mcore-megatron-dev:flamingo-2b-ocr-clip336-unfrozen-bf16-localDDP-llamamerge-nogradaccumfusion
...
NAME="flamingo-2b-ocr-clip336-unfrozen-bf16-localDDP-llamamerge-nogradaccumfusion"
LOAD_NAME="gpt3-2b-multi-1.1t-gtc"

#SCRIPTS_DIR="/lustre/fsw/adlr/adlr-nlp/jbarker/next-llm/source"
SOURCE="/lustre/fsw/sa/wdykas/code/debug-flamingo/llama-branch-merge/megatron-lm"

OUTPUT="/lustre/fsw/sa/wdykas/code/debug-outputs/${NAME}"
mkdir -p ${OUTPUT}/logs
...
DATA_TRAIN="/lustre/fsw/sa/wdykas/ocr.yaml"
DATA_VALID="/lustre/fsw/sa/wdykas/ocr.yaml"

VISUAL_ARCH="L_14"
VISUAL_TYPE="vit"
VISUAL_LOAD_DIR="/lustre/fsw/sa/wdykas/vit_L_14_336px"
...
srun -l --verbose \
    --container-image /lustre/fsw/sa/wdykas/code/debug-flamingo/adlr+megatron-lm+pytorch+23.04-py3-jbarker.sqsh \
